...
//   wp_register_script('SFSIJquery', 'http://code.jquery.com/jquery-1.9.1.js', array('jquery'));
    wp_register_script('SFSIJquery', "" . get_template_directory_uri() . "/js/jquery.js" , array('jquery'));
...
//    wp_register_script('SFSIMigrate', 'http://code.jquery.com/jquery-migrate-1.1.0.min.js', array('jquery'),'',true);
    wp_register_script('SFSIMigrate', "" . get_template_directory_uri() . "/js/jquery-migrate-1.1.0.min.js", array('jquery'),'',true);
