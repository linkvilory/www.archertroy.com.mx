...
function sfsi_social_buttons_below($content) {
  ...
  /* 
    Obtener el tipo de publicación y
    si es 'proyecto' entonces mostrar los iconos
  */
    $post_type = get_post_type();
  
    if(!is_feed() && !is_home() && !is_page() && $post_type == 'proyecto') {
...
/* Únicamente incluir los scripts de redes sociales en las publicaciones */
if(!is_admin() && $post_type == 'proyecto') {
   global $post;
