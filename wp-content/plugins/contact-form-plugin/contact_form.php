...
Description: NO ACTUALIZAR  porque se hicieron modificaciones al plugin. NO FUNCIONA EN MU-PLUGINS. Plugin for Contact Form.
Author: BestWebSoft
Version: 3.84
...
*/
				$content .= '<div style="text-align: left;">
						<input class="text" type="text" size="40" value="' . $name . '" name="cntctfrm_contact_name" id="cntctfrm_contact_name" placeholder="Nombre" style="text-align: left; margin: 0;" />
					</div>';
		/*	} */
...
*/
			...
			$content .= '<div style="text-align: left;">
					<input class="text" type="text" size="40" value="' . $email . '" name="cntctfrm_contact_email" id="cntctfrm_contact_email" placeholder="Correo" style="text-align: left; margin: 0;" /></div>';
...
*/
			...
			$content .= '<div style="text-align: left;">
					<textarea rows="5" cols="30" name="cntctfrm_contact_message" id="cntctfrm_contact_message" placeholder="Mensaje">' . $message . '</textarea>
				</div>';
