...
add_action('wp_ajax_visualize_post', 'visualize_post');
add_action('wp_ajax_nopriv_visualize_post', 'visualize_post');

function visualize_post() {
  $proyecto_id = $_GET['id'];
  $args = array('post_type' => 'any', 'post__in' => array($proyecto_id));
...
add_action('wp_ajax_previous_next', 'previous_next');
add_action('wp_ajax_nopriv_previous_next', 'previous_next');
...
/**
*
* Returns if the current docuemtn is blog or news feed
*
**/
