...
(function() {
  ...
  this.audioPlayer = new AudioPlayerUI({
    ...
    songs: [
      {
        image: "/wp-content/uploads/proyectos/radio-audios/Fast-Forward.png",
        name: "Fast Foward",
        srcs: [
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Fast-Forward.mp3",
            type: "audio/mp3"
          },
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Fast-Forward.ogg",
            type: "audio/ogg"
          },
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Fast-Forward.wav",
            type: "audio/wav"
          }
        ]
      }
