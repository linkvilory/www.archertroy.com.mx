...
(function() {
  ...
  this.audioPlayer = new AudioPlayerUI({
    ...
    songs: [
      {
        image: "/wp-content/uploads/proyectos/radio-audios/Arvm.png",
        name: "ARVM - Claxons -Concurso ángel social",
        srcs: [
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Arvm-Claxons.mp3",
            type: "audio/mp3"
          },
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Arvm-Claxons.ogg",
            type: "audio/ogg"
          },
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Arvm-Claxons.wav",
            type: "audio/wav"
          }
        ]
      },
      {
        image: "/wp-content/uploads/proyectos/radio-audios/Arvm.png",
        name: "ARVM - Colchones - Concurso ángel social",
        srcs: [
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Arvm-Colchones.mp3",
            type: "audio/mp3"
          },
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Arvm-Colchones.ogg",
            type: "audio/ogg"
          },
          {
            src: "/wp-content/uploads/proyectos/radio-audios/Arvm-Colchones.wav",
            type: "audio/wav"
          }
        ]
      }
